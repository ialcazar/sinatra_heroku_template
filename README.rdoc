...
If you want to switch to classic style you just have to change the <code>config.ru</code> file and the base class of the app <code>lib/base/app.rb</code>. Checkout https://github.com/sinatra/sinatra under <i>Modular vs. Classic Style</i>.
